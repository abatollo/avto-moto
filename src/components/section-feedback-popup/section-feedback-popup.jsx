        ...
        <div className="popup__wrapper">
          ...
          <form className="feedback-form" id="feedback-form" method="POST" action="https://echo.htmlacademy.ru">
            <div className="feedback-form__input-wrapper--name">
              ...
              <input className={`feedback-form__input feedback-form__input--name${nameError ? ` feedback-form__input--error` : ``}`} ref={refNameInput} type="text" name="name" id="feedback-form-name" placeholder="Имя" value={name} onChange={(evt) => {handleNameChange(evt)}} required />
            </div>
